...
├── Day2_Pandas/
├── Day3_EDA/
├── Day4_FeatureEngineering/
├── Day5_LogisticRegression/
├── Day6_TreeModels/
└── Day7_Tuning/
...
## **🌲 Day 6 — Tree Models (Decision Tree & Random Forest)**
...
### ✔ Using metrics: Accuracy, Precision, Recall, F1, ROC & AUC  
### ✔ Using tree-based models  
### ✔ Hyperparameter tuning  
### ✔ Saving and loading models  
### ✔ Maintaining project structure in GitHub  

---

# 🚀 **Final Deliverable of Week 1**
...
- Proper documentation in each day’s README  
